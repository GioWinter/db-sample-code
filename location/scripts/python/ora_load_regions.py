...
# Declare dataset
dfContinents = pd.read_csv(r"C:\Users\gwinter\Documents\db-sample-code\location\public_datasets\csv\regions.csv",index_col=False)
...
try:
    ...
    if conn:
        ...
        for i,row in dfContinents.iterrows():
            sql = "INSERT INTO LOC.REGIONS(REGION_ID,REGION_NAME) VALUES(:1,:2)"
